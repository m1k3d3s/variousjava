...
public class DynamicLineChart extends Application {
    ...
    @Override public void start(Stage stage) {
        ...
        lineChart.setTitle("Test_Chart, 2015");
        ...
        task.valueProperty().addListener(new ChangeListener<Date>() {
            ...
            public void changed(ObservableValue<? extends Date> observableValue, Date oldDate, Date newDate) {
                ...
                xyList1.add(new XYChart.Data(strDate, Integer.valueOf(newDate.getMinutes() + random.nextInt(100))));
                //xyList2.add(new XYChart.Data(strDate, Integer.valueOf(newDate.getMinutes() + random.nextInt(100) - random.nextInt(100))));
